...
<main class="login-shell">
    ...
    <section class="login-form">
        ...
        <?php echo $__env->make('componentes.errores', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <form method="POST" action="<?php echo e(route('iniciar-sesion.guardar')); ?>" id="formularioLogin">
            <?php echo csrf_field(); ?>
            <div class="mb-3"><label for="email" class="form-label">Correo electrónico</label><div class="input-group"><span class="input-group-text bg-white"><i class="bi bi-envelope"></i></span><input id="email" type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="administrador@rivermall.com" required autofocus autocomplete="email"></div></div>
...
<?php /**PATH C:\Xampp\htdocs\COOPERATIVA\resources\views/autenticacion/iniciar_sesion.blade.php ENDPATH**/ ?>